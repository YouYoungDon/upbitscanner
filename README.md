...
- **저유동성 감점** — 24h 거래대금 구간별 ×0.6~1.0 · 5억 미만 메인 분리 (50억+ ×1.0 / 20~50억 ×0.9 / 5~20억 ×0.8 / 1~5억 ×0.6).
...
| 거래량확인 보너스 | ×1.3~1.6 (배율 비례) | 거래량 급증 동반 (2~10x ×1.3 / 10~20x ×1.45 / 20x+ ×1.6) |
...
| `거래량 급증` | +1~+4 (2/5/10/20x 등급) · +2% 상승 동반 시 매수 유효 (2~5x=+1, 5~10x=+2, 10~20x=+3, 20x+=+4) |
| `지속성` | 직전 스캔 이력 기반 반복등장 +1/+2, 거래량 지속 +1, 1회성 점화(거래량 소멸) 경고 |
